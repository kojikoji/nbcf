...
##' 
##' @slot count.mat This is a sparse countmatrix (dgCMatrix), whose rows represent time, and columns represent variate.
##' @slot t.vec This is a numeric vector, whose elements represent observed time corresponding to each row of count matrix.
##' @slot mean.bias.vec This is a numeric vector, whose elements represent expted bias for mean value of each row.
##' @slot params This is a named list of parameters, whose mebers must be "lambda", "r", "alpha" and "beta".
##' @slot lnb.dict Storage for precomputated log negative binomial probability. This is a instance of  \code{\link{LnbDict}}.
